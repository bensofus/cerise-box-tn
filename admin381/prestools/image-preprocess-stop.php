...
if(!@include 'approve.php') die( "approve.php was not found!");
 ...
 { $cquery="UPDATE ". _DB_PREFIX_."configuration";
   $cquery .= ' SET value=1,date_upd=NOW() WHERE id_shop IS NULL AND id_shop_group IS NULL AND name="PRESTOOLS_IMPREP_STOPFLAG"';
 }
 else
 { $cquery="INSERT INTO ". _DB_PREFIX_."configuration";
   $cquery .= ' SET id_shop=NULL, id_shop_group=NULL, name="PRESTOOLS_IMPREP_STOPFLAG", value="1", date_add=NOW(), date_upd=NOW()';
 }
 $res = dbquery($cquery);
